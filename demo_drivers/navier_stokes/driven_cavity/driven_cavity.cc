...
int main()
{
  ...
  // Doing QCrouzeixRaviartElements
  {
    ...
    RectangularDrivenCavityProblem<QGeneralisedFluidElement<2>> problem;
    cout << "Doing QGeneralisedFluidElement<2>" << std::endl;

    problem.assign_initial_values_impulsive(0.1);
